...
# Unit tests for Emailguard::CreateNotificationRuleInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::CreateNotificationRuleInput do
  #let(:instance) { Emailguard::CreateNotificationRuleInput.new }

  describe 'test an instance of CreateNotificationRuleInput' do
    it 'should create an instance of CreateNotificationRuleInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::CreateNotificationRuleInput)
    end
  end
