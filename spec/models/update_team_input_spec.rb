...
# Unit tests for Emailguard::UpdateTeamInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::UpdateTeamInput do
  #let(:instance) { Emailguard::UpdateTeamInput.new }

  describe 'test an instance of UpdateTeamInput' do
    it 'should create an instance of UpdateTeamInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::UpdateTeamInput)
    end
  end
