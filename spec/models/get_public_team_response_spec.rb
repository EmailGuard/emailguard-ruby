...
# Unit tests for Emailguard::GetPublicTeamResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::GetPublicTeamResponse do
  #let(:instance) { Emailguard::GetPublicTeamResponse.new }

  describe 'test an instance of GetPublicTeamResponse' do
    it 'should create an instance of GetPublicTeamResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::GetPublicTeamResponse)
    end
  end
