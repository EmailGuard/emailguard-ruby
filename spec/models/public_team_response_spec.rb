...
# Unit tests for Emailguard::PublicTeamResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::PublicTeamResponse do
  #let(:instance) { Emailguard::PublicTeamResponse.new }

  describe 'test an instance of PublicTeamResponse' do
    it 'should create an instance of PublicTeamResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::PublicTeamResponse)
    end
  end
