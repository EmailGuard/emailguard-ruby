...
# Unit tests for Emailguard::EmailDetectResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::EmailDetectResponse do
  #let(:instance) { Emailguard::EmailDetectResponse.new }

  describe 'test an instance of EmailDetectResponse' do
    it 'should create an instance of EmailDetectResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::EmailDetectResponse)
    end
  end
