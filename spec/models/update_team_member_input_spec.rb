...
# Unit tests for Emailguard::UpdateTeamMemberInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::UpdateTeamMemberInput do
  #let(:instance) { Emailguard::UpdateTeamMemberInput.new }

  describe 'test an instance of UpdateTeamMemberInput' do
    it 'should create an instance of UpdateTeamMemberInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::UpdateTeamMemberInput)
    end
  end
