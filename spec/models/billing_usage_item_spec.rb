...
# Unit tests for Emailguard::BillingUsageItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::BillingUsageItem do
  #let(:instance) { Emailguard::BillingUsageItem.new }

  describe 'test an instance of BillingUsageItem' do
    it 'should create an instance of BillingUsageItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::BillingUsageItem)
    end
  end
