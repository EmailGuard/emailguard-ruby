...
# Unit tests for Emailguard::BillingUsageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Emailguard::BillingUsageResponse do
  #let(:instance) { Emailguard::BillingUsageResponse.new }

  describe 'test an instance of BillingUsageResponse' do
    it 'should create an instance of BillingUsageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Emailguard::BillingUsageResponse)
    end
  end
